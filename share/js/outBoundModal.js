$(function () {
    ...
    * ======================================== */
    (function () {
        var $a = $('a,area').not('a[href^="mailto:"], a[href^="tel:"], .outBoundModalLink');
